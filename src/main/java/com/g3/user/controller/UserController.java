...
public class UserController {
	...
	@GetMapping
	public ResponseEntity<List<User>> getAll(@RequestParam(name = "page") int pageValue,
	...
	@PutMapping("/{userId}")
	public ResponseEntity<User> updateUser(@PathVariable Long userId, @Valid @RequestBody User newUserData,
	...
	@GetMapping("search")
	public ResponseEntity<List<User>> searchUserByParameters(@RequestParam(required = false) String name,
	...
	// ------ Outra forma de fazer as buscas a seguir. Apagar quando refatorar, se
	// for o caso.
